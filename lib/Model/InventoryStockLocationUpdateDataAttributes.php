...
/**
 * InventoryStockLocationUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryStockLocationUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryStockLocationUpdate_data_attributes';
     ...
     * Sets priority
     *
     * @param int|null $priority The stock location priority within the associated invetory model.
     *
     * @return self
     */
     ...
     * Sets on_hold
     *
     * @param bool|null $on_hold Indicates if the shipment should be put on hold if fulfilled from the associated stock location. This is useful to manage use cases like back-orders, pre-orders or personalized orders that need to be customized before being fulfilled.
     *
     * @return self
     */
