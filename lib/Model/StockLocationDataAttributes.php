...
/**
 * StockLocationDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StockLocationDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stockLocation_data_attributes';
     ...
     * Sets number
     *
     * @param int|null $number Unique identifier for the stock location (numeric)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The stock location's internal name.
     *
     * @return self
     */
