...
/**
 * CheckoutComPaymentCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutComPaymentCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'checkoutComPaymentCreate_data_attributes';
     ...
     * Sets payment_type
     *
     * @param string $payment_type The payment source type.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token The Checkout.com card or digital wallet token.
     *
     * @return self
     */
