...
/**
 * FixedAmountPromotionCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FixedAmountPromotionCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fixedAmountPromotionCreate_data_attributes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fixed_amount_cents'] === null) {
            $invalidProperties[] = "'fixed_amount_cents' can't be null";
        }
     ...
     *
     * @param int $fixed_amount_cents The discount fixed amount to be applied, in cents
     *
     * @return self
     */
