...
/**
 * PaypalGatewayUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaypalGatewayUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paypalGatewayUpdate_data_attributes';
     ...
     * Sets client_id
     *
     * @param string|null $client_id The gateway client ID.
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret The gateway client secret.
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string|null $mode The gateway mode, either 'sandbox' or 'live'.
     *
     * @return self
     */
