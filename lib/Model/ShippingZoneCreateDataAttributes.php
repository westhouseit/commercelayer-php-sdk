...
/**
 * ShippingZoneCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingZoneCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shippingZoneCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The shipping zone's internal name.
     *
     * @return self
     */
