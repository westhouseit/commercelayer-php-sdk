...
/**
 * DeliveryLeadTimeDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryLeadTimeDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deliveryLeadTime_data_attributes';
    ...
    {
        $this->container['min_hours'] = $data['min_hours'] ?? null;
        $this->container['max_hours'] = $data['max_hours'] ?? null;
        $this->container['min_days'] = $data['min_days'] ?? null;
        $this->container['max_days'] = $data['max_days'] ?? null;
     ...
     * Sets min_hours
     *
     * @param int|null $min_hours The delivery lead minimum time (in hours) when shipping from the associated stock location with the associated shipping method.
     *
     * @return self
     */
     ...
     * Sets max_hours
     *
     * @param int|null $max_hours The delivery lead maximun time (in hours) when shipping from the associated stock location with the associated shipping method.
     *
     * @return self
     */
    ...
    {
        return $this->container['min_days'];
    }

    /**
     * Sets min_days
     *
     * @param int|null $min_days The delivery lead minimum time, in days (rounded)
     *
     * @return self
     */
    public function setMinDays($min_days)
    {
        $this->container['min_days'] = $min_days;
    ...
    {
        return $this->container['max_days'];
    }

    /**
     * Sets max_days
     *
     * @param int|null $max_days The delivery lead maximun time, in days (rounded)
     *
     * @return self
     */
    public function setMaxDays($max_days)
    {
        $this->container['max_days'] = $max_days;
