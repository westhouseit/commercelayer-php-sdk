...
/**
 * StripePaymentDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StripePaymentDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stripePayment_data_attributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['publishable_key'] = $data['publishable_key'] ?? null;
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret The Stripe payment intent client secret. Required to create a charge through Stripe.js.
     *
     * @return self
     */
     ...
     *
     * @param string|null $publishable_key The Stripe publishable API key.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options Stripe payment options: 'setup_future_usage', 'customer', and 'payment_method'
     *
     * @return self
     */
     ...
     * Sets payment_method
     *
     * @param object|null $payment_method Stripe 'payment_method', set by webhook.
     *
     * @return self
     */
