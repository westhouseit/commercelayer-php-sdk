...
/**
 * ExternalPaymentDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalPaymentDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'externalPayment_data_attributes';
     ...
     *
     * @param string|null $payment_source_token The payment source token, as generated by the external gateway SDK. Credit Card numbers are rejected.
     *
     * @return self
     */
