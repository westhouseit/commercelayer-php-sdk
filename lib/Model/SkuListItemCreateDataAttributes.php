...
/**
 * SkuListItemCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkuListItemCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'skuListItemCreate_data_attributes';
     ...
     * Sets position
     *
     * @param int $position The sku list item's position.
     *
     * @return self
     */
