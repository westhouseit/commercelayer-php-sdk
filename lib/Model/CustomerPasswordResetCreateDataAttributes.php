...
/**
 * CustomerPasswordResetCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerPasswordResetCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerPasswordResetCreate_data_attributes';
     ...
     * Sets customer_email
     *
     * @param string $customer_email The email of the customer that requires a password reset
     *
     * @return self
     */
