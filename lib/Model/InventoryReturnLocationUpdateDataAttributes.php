...
/**
 * InventoryReturnLocationUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryReturnLocationUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryReturnLocationUpdate_data_attributes';
     ...
     * Sets priority
     *
     * @param int|null $priority The inventory return location priority within the associated invetory model.
     *
     * @return self
     */
