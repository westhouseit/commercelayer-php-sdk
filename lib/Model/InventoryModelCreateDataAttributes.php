...
/**
 * InventoryModelCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryModelCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryModelCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The inventory model's internal name.
     *
     * @return self
     */
     ...
     * Sets strategy
     *
     * @param string $strategy The inventory model's shipping strategy: one between 'split_shipments' (default), 'ship_from_primary', 'ship_from_first_available_or_primary' and 'ship_from_most_available'.
     *
     * @return self
     */
