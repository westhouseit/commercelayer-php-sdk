...
/**
 * PriceCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PriceCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'priceCreate_data_attributes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['compare_at_amount_cents'] === null) {
            $invalidProperties[] = "'compare_at_amount_cents' can't be null";
        }
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The sku price amount for the associated price list, in cents.
     *
     * @return self
     */
     ...
     *
     * @param int $compare_at_amount_cents The compared price amount, in cents. Useful to display a percentage discount.
     *
     * @return self
     */
