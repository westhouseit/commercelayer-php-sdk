...
/**
 * CouponCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'couponCreate_data_attributes';
     ...
     * Sets code
     *
     * @param string $code The coupon code, that uniquely identifies the coupon within the promotion rule.
     *
     * @return self
     */
     ...
     * Sets usage_limit
     *
     * @param int $usage_limit The total number of times this coupon can be used.
     *
     * @return self
     */
