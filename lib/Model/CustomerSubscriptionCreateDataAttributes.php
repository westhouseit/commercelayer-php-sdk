...
/**
 * CustomerSubscriptionCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerSubscriptionCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerSubscriptionCreate_data_attributes';
     ...
     * Sets customer_email
     *
     * @param string $customer_email The email of the customer that owns the subscription
     *
     * @return self
     */
