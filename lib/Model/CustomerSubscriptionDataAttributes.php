...
/**
 * CustomerSubscriptionDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerSubscriptionDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerSubscription_data_attributes';
     ...
     * Sets customer_email
     *
     * @param string|null $customer_email The email of the customer that owns the subscription
     *
     * @return self
     */
