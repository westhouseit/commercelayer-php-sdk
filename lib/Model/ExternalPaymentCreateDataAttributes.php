...
/**
 * ExternalPaymentCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalPaymentCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'externalPaymentCreate_data_attributes';
     ...
     *
     * @param string $payment_source_token The payment source token, as generated by the external gateway SDK. Credit Card numbers are rejected.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options External payment options
     *
     * @return self
     */
