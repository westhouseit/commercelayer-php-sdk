...
/**
 * MerchantUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MerchantUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'merchantUpdate_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name The merchant's internal name
     *
     * @return self
     */
