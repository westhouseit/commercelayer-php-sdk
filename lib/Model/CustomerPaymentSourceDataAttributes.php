...
/**
 * CustomerPaymentSourceDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerPaymentSourceDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerPaymentSource_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name Returns the associated payment source's name
     *
     * @return self
     */
     ...
     * Sets customer_token
     *
     * @param string|null $customer_token Returns the customer gateway token stored in the gateway
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_source_token Returns the payment source token stored in the gateway
     *
     * @return self
     */
