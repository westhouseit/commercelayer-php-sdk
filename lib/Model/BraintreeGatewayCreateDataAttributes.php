...
/**
 * BraintreeGatewayCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BraintreeGatewayCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'braintreeGatewayCreate_data_attributes';
     ...
     *
     * @param string $merchant_account_id The gateway merchant account ID.
     *
     * @return self
     */
     ...
     * Sets merchant_id
     *
     * @param string $merchant_id The gateway merchant ID.
     *
     * @return self
     */
     ...
     * Sets public_key
     *
     * @param string $public_key The gateway API public key.
     *
     * @return self
     */
     ...
     * Sets private_key
     *
     * @param string $private_key The gateway API private key.
     *
     * @return self
     */
