...
/**
 * SkuListDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkuListDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'skuList_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name The sku list's internal name.
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string|null $slug The sku list's internal slug.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description An internal description of the sku list.
     *
     * @return self
     */
     ...
     * Sets manual
     *
     * @param bool|null $manual Indicates if the sku list is populated manually.
     *
     * @return self
     */
