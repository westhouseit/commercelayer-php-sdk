...
/**
 * CustomerAddressDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerAddressDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerAddress_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name Returns the associated address' name
     *
     * @return self
     */
