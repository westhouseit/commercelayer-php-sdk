...
/**
 * SkuListItemUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkuListItemUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'skuListItemUpdate_data_attributes';
     ...
     * Sets position
     *
     * @param int|null $position The sku list item's position.
     *
     * @return self
     */
