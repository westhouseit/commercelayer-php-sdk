...
/**
 * PaypalPaymentCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaypalPaymentCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paypalPaymentCreate_data_attributes';
     ...
     * Sets return_url
     *
     * @param string $return_url The URL where the payer is redirected after they approve the payment.
     *
     * @return self
     */
     ...
     * Sets cancel_url
     *
     * @param string $cancel_url The URL where the payer is redirected after they cancel the payment.
     *
     * @return self
     */
