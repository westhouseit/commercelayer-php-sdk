...
/**
 * ExternalTaxCalculatorUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalTaxCalculatorUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'externalTaxCalculatorUpdate_data_attributes';
     ...
     *
     * @param string|null $tax_calculator_url The URL to the service that will compute the taxes.
     *
     * @return self
     */
