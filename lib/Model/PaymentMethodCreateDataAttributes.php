...
/**
 * PaymentMethodCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentMethodCreate_data_attributes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_source_type'] === null) {
            $invalidProperties[] = "'payment_source_type' can't be null";
        }
        if ($this->container['price_amount_cents'] === null) {
            $invalidProperties[] = "'price_amount_cents' can't be null";
        }
     ...
     *
     * @param string $payment_source_type The payment source type, can be one of: 'AdyenPayment', 'BraintreePayment', 'CheckoutComPayment', 'CreditCard', 'ExternalPayment', 'PaypalPayment', 'StripePayment', or 'WireTransfer'.
     *
     * @return self
     */
     ...
     *
     * @param int $price_amount_cents The payment method's price, in cents
     *
     * @return self
     */
