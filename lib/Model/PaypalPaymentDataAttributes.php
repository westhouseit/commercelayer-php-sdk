...
/**
 * PaypalPaymentDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaypalPaymentDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paypalPayment_data_attributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['note_to_payer'] = $data['note_to_payer'] ?? null;
        $this->container['paypal_payer_id'] = $data['paypal_payer_id'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['paypal_id'] = $data['paypal_id'] ?? null;
     ...
     * Sets return_url
     *
     * @param string|null $return_url The URL where the payer is redirected after they approve the payment.
     *
     * @return self
     */
     ...
     * Sets cancel_url
     *
     * @param string|null $cancel_url The URL where the payer is redirected after they cancel the payment.
     *
     * @return self
     */
     ...
     * Sets note_to_payer
     *
     * @param string|null $note_to_payer A free-form field that you can use to send a note to the payer on PayPal.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The PayPal payer id (if present)
     *
     * @return self
     */
     ...
     * Sets paypal_id
     *
     * @param string|null $paypal_id The id of the PayPal payment object.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The PayPal payment status. One of 'created' (default) or 'approved'.
     *
     * @return self
     */
     ...
     * Sets approval_url
     *
     * @param string|null $approval_url The URL the customer should be redirected to approve the payment.
     *
     * @return self
     */
