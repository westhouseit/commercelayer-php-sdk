...
/**
 * GiftCardRecipientCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GiftCardRecipientCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'giftCardRecipientCreate_data_attributes';
     ...
     * Sets email
     *
     * @param string $email The gift card recipient email address
     *
     * @return self
     */
