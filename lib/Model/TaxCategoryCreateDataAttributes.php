...
/**
 * TaxCategoryCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaxCategoryCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'taxCategoryCreate_data_attributes';
     ...
     * Sets code
     *
     * @param string $code The tax category identifier code, specific for a particular tax calculator.
     *
     * @return self
     */
