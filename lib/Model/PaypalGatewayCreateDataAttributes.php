...
/**
 * PaypalGatewayCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaypalGatewayCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paypalGatewayCreate_data_attributes';
     ...
     * Sets client_id
     *
     * @param string $client_id The gateway client ID.
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret The gateway client secret.
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string $mode The gateway mode, either 'sandbox' or 'live'.
     *
     * @return self
     */
