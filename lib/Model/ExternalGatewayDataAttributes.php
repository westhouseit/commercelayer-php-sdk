...
/**
 * ExternalGatewayDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalGatewayDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'externalGateway_data_attributes';
     ...
     * Sets shared_secret
     *
     * @param string|null $shared_secret The shared secret used to sign gateway payloads.
     *
     * @return self
     */
