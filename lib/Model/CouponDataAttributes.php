...
/**
 * CouponDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'coupon_data_attributes';
     ...
     * Sets code
     *
     * @param string|null $code The coupon code, that uniquely identifies the coupon within the promotion rule.
     *
     * @return self
     */
     ...
     * Sets usage_limit
     *
     * @param int|null $usage_limit The total number of times this coupon can be used.
     *
     * @return self
     */
     ...
     * Sets usage_count
     *
     * @param int|null $usage_count The number of times this coupon has been used.
     *
     * @return self
     */
