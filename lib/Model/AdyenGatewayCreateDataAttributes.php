...
/**
 * AdyenGatewayCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdyenGatewayCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'adyenGatewayCreate_data_attributes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['live_url_prefix'] === null) {
            $invalidProperties[] = "'live_url_prefix' can't be null";
        }
     ...
     *
     * @param string $merchant_account The gateway merchant account.
     *
     * @return self
     */
     ...
     *
     * @param string $live_url_prefix The prefix of the endpoint used for live transactions.
     *
     * @return self
     */
