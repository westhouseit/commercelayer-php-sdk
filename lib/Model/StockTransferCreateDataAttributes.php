...
/**
 * StockTransferCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StockTransferCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stockTransferCreate_data_attributes';
     ...
     * Sets quantity
     *
     * @param int $quantity The stock quantity to be transferred from the origin stock location to destination one
     *
     * @return self
     */
