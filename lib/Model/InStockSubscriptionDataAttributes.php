...
/**
 * InStockSubscriptionDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InStockSubscriptionDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inStockSubscription_data_attributes';
     ...
     * Sets status
     *
     * @param string|null $status The subscription status. One of 'active' (default), 'inactive', or 'notified'
     *
     * @return self
     */
     ...
     * Sets customer_email
     *
     * @param string|null $customer_email The email of the associated customer, replace the relationship
     *
     * @return self
     */
