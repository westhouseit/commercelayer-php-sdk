...
/**
 * ShippingCategoryCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingCategoryCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shippingCategoryCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The shipping category name.
     *
     * @return self
     */
