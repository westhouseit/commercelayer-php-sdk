...
/**
 * PercentageDiscountPromotionCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PercentageDiscountPromotionCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'percentageDiscountPromotionCreate_data_attributes';
     ...
     * Sets percentage
     *
     * @param int $percentage The discount percentage to be applied.
     *
     * @return self
     */
