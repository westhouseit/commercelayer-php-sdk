...
/**
 * CustomerDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_data_attributes';
     ...
     * Sets status
     *
     * @param string|null $status The customer's status, one of 'prospect', 'acquired', or 'repeat'.
     *
     * @return self
     */
     ...
     * Sets has_password
     *
     * @param bool|null $has_password Indicates if the customer has a password.
     *
     * @return self
     */
