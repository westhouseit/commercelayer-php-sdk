...
/**
 * CustomerGroupCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerGroupCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerGroupCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The customer group's internal name
     *
     * @return self
     */
