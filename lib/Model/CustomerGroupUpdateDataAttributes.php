...
/**
 * CustomerGroupUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerGroupUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerGroupUpdate_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name The customer group's internal name
     *
     * @return self
     */
