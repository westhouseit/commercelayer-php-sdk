...
/**
 * StockTransferDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StockTransferDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stockTransfer_data_attributes';
     ...
     * Sets status
     *
     * @param string|null $status The stock transfer status, one of 'draft', 'upcoming', 'picking', 'in_transit', 'completed', or 'cancelled'
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The stock quantity to be transferred from the origin stock location to destination one
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param string|null $completed_at Time at which the stock transfer was completed.
     *
     * @return self
     */
     ...
     * Sets cancelled_at
     *
     * @param string|null $cancelled_at Time at which the stock transfer was cancelled.
     *
     * @return self
     */
