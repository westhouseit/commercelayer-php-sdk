...
/**
 * ExternalPromotionUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalPromotionUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'externalPromotionUpdate_data_attributes';
     ...
     * Sets promotion_url
     *
     * @param string|null $promotion_url The URL to the service that will compute the discount.
     *
     * @return self
     */
