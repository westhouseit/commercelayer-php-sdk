...
/**
 * AdjustmentDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdjustmentDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'adjustment_data_attributes';
     ...
     * Sets amount_float
     *
     * @param float|null $amount_float The adjustment amount, float.
     *
     * @return self
     */
     ...
     *
     * @param string|null $formatted_amount The adjustment amount, formatted.
     *
     * @return self
     */
