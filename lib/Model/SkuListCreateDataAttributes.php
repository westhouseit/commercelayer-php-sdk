...
/**
 * SkuListCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkuListCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'skuListCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The sku list's internal name.
     *
     * @return self
     */
