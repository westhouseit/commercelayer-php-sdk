...
/**
 * WebhookCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhookCreate_data_attributes';
     ...
     * Sets topic
     *
     * @param string $topic The identifier of the resource/event that will trigger the webhook.
     *
     * @return self
     */
     ...
     * Sets callback_url
     *
     * @param string $callback_url URI where the webhook subscription should send the POST request when the event occurs.
     *
     * @return self
     */
