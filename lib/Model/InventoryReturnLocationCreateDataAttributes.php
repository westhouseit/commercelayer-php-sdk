...
/**
 * InventoryReturnLocationCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryReturnLocationCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryReturnLocationCreate_data_attributes';
     ...
     * Sets priority
     *
     * @param int $priority The inventory return location priority within the associated invetory model.
     *
     * @return self
     */
