...
/**
 * ApplicationDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'application_data_attributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['public_access'] = $data['public_access'] ?? null;
     ...
     * Sets name
     *
     * @param string|null $name The application's internal name.
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind The application's kind, can be one of: 'sales_channel', 'checkout', 'contentful', 'datocms', 'sanity', 'cli', 'integration', 'webapp', 'zapier', or 'channel'
     *
     * @return self
     */
     ...
     * Sets public_access
     *
     * @param string|null $public_access Indicates if the application has public access.
     *
     * @return self
     */
     ...
     * Sets redirect_uri
     *
     * @param string|null $redirect_uri The application's redirect URI.
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string|null $scopes The application's scopes.
     *
     * @return self
     */
