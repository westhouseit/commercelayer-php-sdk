...
/**
 * AttachmentUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachmentUpdate_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name The internal name of the attachment.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description An internal description of the attachment.
     *
     * @return self
     */
