...
/**
 * StripeGatewayCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StripeGatewayCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stripeGatewayCreate_data_attributes';
     ...
     * Sets login
     *
     * @param string $login The gateway login.
     *
     * @return self
     */
     ...
     *
     * @param string|null $publishable_key The gateway publishable API key.
     *
     * @return self
     */
