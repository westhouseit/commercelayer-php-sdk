...
/**
 * SkuOptionCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkuOptionCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'skuOptionCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The sku option's internal name
     *
     * @return self
     */
