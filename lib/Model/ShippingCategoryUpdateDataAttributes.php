...
/**
 * ShippingCategoryUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingCategoryUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shippingCategoryUpdate_data_attributes';
     ...
     * Sets name
     *
     * @param string|null $name The shipping category name.
     *
     * @return self
     */
