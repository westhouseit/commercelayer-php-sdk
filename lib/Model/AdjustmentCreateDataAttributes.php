...
/**
 * AdjustmentCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdjustmentCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'adjustmentCreate_data_attributes';
     ...
     * Sets name
     *
     * @param string $name The adjustment name
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The adjustment amount, in cents.
     *
     * @return self
     */
