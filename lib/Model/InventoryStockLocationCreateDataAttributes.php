...
/**
 * InventoryStockLocationCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryStockLocationCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inventoryStockLocationCreate_data_attributes';
     ...
     * Sets priority
     *
     * @param int $priority The stock location priority within the associated invetory model.
     *
     * @return self
     */
