...
/**
 * TaxjarAccountUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaxjarAccountUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'taxjarAccountUpdate_data_attributes';
     ...
     * Sets api_key
     *
     * @param string|null $api_key The TaxJar account API key.
     *
     * @return self
     */
