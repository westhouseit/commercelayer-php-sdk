...
/**
 * CustomerCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerCreate_data_attributes';
     ...
     * Sets password
     *
     * @param string|null $password The customer's password. Initiate a customer password reset flow if you need to change it.
     *
     * @return self
     */
