...
/**
 * StockItemUpdateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StockItemUpdateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stockItemUpdate_data_attributes';
     ...
     * Sets quantity
     *
     * @param int|null $quantity The stock item quantity.
     *
     * @return self
     */
