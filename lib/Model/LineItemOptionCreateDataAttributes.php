...
/**
 * LineItemOptionCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LineItemOptionCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'lineItemOptionCreate_data_attributes';
     ...
     * Sets quantity
     *
     * @param int $quantity The line item option's quantity
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object $options Set of key-value pairs that represent the selected options.
     *
     * @return self
     */
