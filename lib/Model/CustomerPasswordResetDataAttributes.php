...
/**
 * CustomerPasswordResetDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerPasswordResetDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerPasswordReset_data_attributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reset_password_token'] = $data['reset_password_token'] ?? null;
     ...
     * Sets customer_email
     *
     * @param string|null $customer_email The email of the customer that requires a password reset
     *
     * @return self
     */
     ...
     *
     * @param string|null $reset_password_token Automatically generated on create. Send its value as the '_reset_password_token' argument when updating the customer password.
     *
     * @return self
     */
     ...
     *
     * @param string|null $reset_password_at Time at which the password was reset.
     *
     * @return self
     */
